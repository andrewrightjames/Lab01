...
```{r Ex_d}
#visitors %>% filter(n_2022 == 565,772)
```
...
Non-Applicable, we got this answer for the previous question because we had NA values in the variable 'n_2021'
...
There are large outliers in the data set.
